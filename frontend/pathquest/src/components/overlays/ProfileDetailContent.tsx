            ...
            <div className="flex-1 rounded-2xl bg-background/85 backdrop-blur-xl border border-border shadow-xl overflow-hidden flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 rounded-lg bg-card border border-border/70 text-center">
                            <p className="text-2xl font-bold">{stats?.totalPeaks || 0}</p>
                            <p className="text-xs text-muted-foreground">Peaks Summited</p>
                        </div>
                        <div className="p-3 rounded-lg bg-card border border-border/70 text-center">
                            <p className="text-2xl font-bold">{stats?.totalSummits || 0}</p>
                            <p className="text-xs text-muted-foreground">Total Summits</p>
                        </div>
                    </div>
